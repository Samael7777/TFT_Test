...
void PutString_Hex8(uint8_t chr, TFT_FONT_t *font, uint16_t fc, uint16_t bc );
void PutString_Hex16(uint16_t chr, TFT_FONT_t *font, uint16_t fc, uint16_t bc );
void PutString_Hex32(uint32_t chr, TFT_FONT_t *font, uint16_t fc, uint16_t bc );
